...
you do not have cygwin installed, download the cygwin1.dll and place
it in the same directory as the executables.  The Ubuntu executables
should run without additional support on an Ubuntu machine.  The
text files do not vary between systems.
